...
const Contact = () => {
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5000/api/public/contact",
        formData,
        {
          headers: {
  ...
  return (
    <div className="container mx-auto py-16 flex flex-col gap-20">
      <div
        className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto rounded-lg"
        style={{
          background: "linear-gradient(to right, #0404a4 0%, #0404a4 100%)",
        }}
      >
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
          <div>
            ...
            <ul className="flex mt-12 space-x-4">
              <li className="bg-[#facc15] hover:bg-[#facc15e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <div className="bg-gray-200 p-6 rounded-lg">
            <form className="mt-8 space-y-4">
              <input
                ...
                className="w-full rounded-lg py-3 px-4 text-slate-900 text-sm outline-none"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full rounded-lg px-4 text-slate-900 text-sm pt-3 outline-none"
              ></textarea>
              <button
                type="button"
                onClick={handleSubmit}
                className="text-white bg-[#facc15] hover:bg-[#facc15e2] tracking-wide rounded-lg text-sm font-medium px-4 py-3 flex items-center justify-center w-full !mt-6"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
